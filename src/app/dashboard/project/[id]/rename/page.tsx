      ...
      {dataLoading ? (
        ...
        <div className="grid grid-cols-12 gap-6">
            ...
            <div className="rounded-2xl border border-outline-variant/30 bg-surface-container p-6">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full rounded-xl bg-background px-5 py-4 text-lg font-mono text-on-surface outline-none ring-1 ring-outline-variant/40 focus:ring-primary/50 transition-shadow"
          ...
          <div className="col-span-12 lg:col-span-5">
            <div className="rounded-2xl border border-outline-variant/30 bg-surface-container p-6 sticky top-6">
              ...
              {previews.length === 0 ? (
                ...
                <div className="space-y-0">
                  ...
                  {previews.length > 12 && (
                    <p className="pt-3 text-[11px] text-on-surface-variant/60 text-center">
