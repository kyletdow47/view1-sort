    ...
    <div className="p-6 max-w-[1200px] mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="rounded-2xl border border-outline-variant bg-surface p-6 space-y-5">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-surface-container border border-outline-variant rounded-xl px-4 py-2.5 text-sm text-on-surface placeholder-[#534439] focus:border-primary focus:outline-none transition-colors"
                />
              </div>
              ...
              <button
                ...
                className={`relative rounded-xl border p-5 text-left transition-colors ${
                  pricingModel === 'flat'
                    ...
                    : 'border-outline-variant bg-surface-container hover:border-[#a18d80]'
                }`}
              >
                {pricingModel === 'flat' && (
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative w-11 h-6 rounded-full transition-colors ${
                    previewAccess ? 'bg-[#d48441]' : 'bg-surface-highest'
                  }`}
                >
                  <div
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative w-11 h-6 rounded-full transition-colors ${
                    proofingAccess ? 'bg-[#d48441]' : 'bg-surface-highest'
                  }`}
                >
                  <div
                    className={`absolute top-0.5 w-5 h-5 rounded-full bg-white transition-transform ${
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative w-11 h-6 rounded-full transition-colors ${
                    deliveredAccess ? 'bg-[#d48441]' : 'bg-surface-highest'
                  }`}
                >
                  <div
                    className={`absolute top-0.5 w-5 h-5 rounded-full bg-white transition-transform ${
      ...
      <div className="flex items-center justify-between mt-8 pt-6 border-t border-outline-variant">
        <button className="flex items-center gap-2 rounded-xl border border-[#e7765f]/30 bg-[#e7765f]/10 px-5 py-2.5 text-sm text-rose-400 hover:bg-[#e7765f]/20 transition-colors">
          <Archive size={16} />
          Archive Project
        </button>

        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 rounded-xl border border-outline-variant px-5 py-2.5 text-sm text-on-surface-variant hover:text-on-surface hover:border-[#a18d80] transition-colors">
            <X size={16} />
            Discard Changes
          </button>
          <button className="flex items-center gap-2 rounded-xl bg-gradient-to-br from-[#ffb780] to-[#d48441] px-6 py-2.5 text-sm font-bold text-on-primary hover:opacity-90 transition-opacity">
            <Save size={16} />
            Save Configurations
          </button>
        </div>
