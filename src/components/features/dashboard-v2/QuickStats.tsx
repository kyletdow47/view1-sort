  ...
  const stats = [
    {
      ...
      progress: Math.min(100, pendingActions * 10),
    ...
    },
    {
      ...
      progress: Math.min(100, activeProjectCount * 20),
    ...
    },
    {
      ...
      progress: Math.min(100, upcomingShoots * 15),
    ...
    },
    {
      ...
      progress: Math.min(100, (revenueThisMonth / 500000) * 100),
